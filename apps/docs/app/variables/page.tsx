...
const VARIABLES_LEAD =
  "CADS design variables are generated from the Figma file into @moshebari/cads-variables and exposed as CSS custom properties with semantic names — no --ds- prefix, no raw hex in consuming code.";
  ...
  return (
    <div className={pageStyles.page}>
      <FoundationHeader
        ...
        lead={
          <>
            ...
            <code>@moshebari/cads-variables</code> and exposed as CSS custom
      ...
      <section className={styles.section} aria-labelledby="setup">
        ...
        <div style={{ width: "100%" }}>
          <CodeBlock code={`import "@moshebari/cads-variables/variables.css";`} />
        </div>
      </section>
