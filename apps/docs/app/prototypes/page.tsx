...
const PROTOTYPES_LEAD =
  "Designer-created prototypes built with @moshebari/cads-react land here so engineers can inspect real component and prop usage — not screenshots alone.";
      ...
      <PageHeader
        ...
        lead={
          <>
            ...
            <code>@moshebari/cads-react</code> land here so engineers can inspect
