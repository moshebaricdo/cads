...
description: Prototype UI or build/update CADS components with @moshebari/cads-react and @moshebari/cads-variables at Figma fidelity. Use for CADS Figma mocks, designer prototypes, and every new or updated CodeAI design-system component.
---
...
- Icons: `FaIcon` from `@moshebari/cads-react/icons` with FA 7 names (Free webfont; Pro-only glyphs are empty).
