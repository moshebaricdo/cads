 ...
 * (Press / Surface / Indicator / Fade / Highlight chase).
 */
declare const motion: {
    ...
    /** Committed selection chrome that moves (toggle handle, selected pill). Duration = medium. */
    readonly indicator: {
        readonly duration: "200ms";
    ...
    /** Ephemeral hover highlight that follows the pointer across list rows. Duration = fast. */
