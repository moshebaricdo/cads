...
function nonColorCssVars() {
  return {
    ...
    "--transition-indicator": `left var(--motion-indicator-duration) var(--motion-indicator-easing), transform var(--motion-indicator-duration) var(--motion-indicator-easing), background-color var(--duration-short) var(--easing-standard)`,
...
//# sourceMappingURL=chunk-ZQJYS62I.js.map