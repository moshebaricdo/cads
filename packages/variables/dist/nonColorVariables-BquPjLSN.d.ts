 ...
 */
declare function pxToRem(pxValue: string): string;
...
export { type MotionSpringPreset as M, type ZIndexLayer as Z, spacing as a, zIndexLayers as b, controlHeights as c, elevation as e, motion as m, nonColorCssVars as n, pxToRem as p, shape as s, typography as t, zIndex as z };
