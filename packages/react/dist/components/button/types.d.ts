...
/** Figma Button `color`. */
export type ButtonColor = "primary" | "secondary" | "tertiary" | "orange" | "error";
/** Figma size scale. */
export type ButtonSize = ControlSize;
export interface ButtonProps extends Omit<MuiButtonProps, "variant" | "color" | "size" | "startIcon" | "endIcon" | "loading" | "loadingIndicator" | "loadingPosition"> {
    /**
