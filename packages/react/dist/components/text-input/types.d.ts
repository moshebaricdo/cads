...
import { FieldSentiment } from '../field-wrapper/types';
...
export type SharedNativeProps = Omit<InputHTMLAttributes<HTMLInputElement>, "size" | "color" | "value" | "defaultValue" | "onChange" | "children">;
