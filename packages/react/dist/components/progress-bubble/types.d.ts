 ...
 */
export type ProgressBubbleLevelType = "default" | "panelLevel" | "lessonExtras" | "tutorPlus";
/** Figma Progress Bubbles `status` (ignored for lessonExtras / tutorPlus). */
export type ProgressBubbleStatus = "notStarted" | "inProgress" | "passed" | "completed" | "error";
export interface ProgressBubbleProps extends Omit<ButtonBaseProps, "children" | "color"> {
    /**
