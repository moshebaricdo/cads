 ...
 */
export declare const ExperimentalMotionContext: import('react').Context<boolean>;
export declare function useExperimentalMotion(): boolean;
 ...
 */
export declare function springTransition(name: MotionSpringName, reduceMotion: boolean | null | undefined): Transition;
/** Read `--motion-surface-duration` from the document (fallback 200ms = medium). */
export declare function readSurfaceDurationMs(): number;
/**
 ...
 */
export declare function useSurfacePresence(open: boolean): {
    mounted: boolean;
    exiting: boolean;
};
/**
