    ...
    },
    {
      ...
      props: [
        ...
        { name: "onClose", type: "() => void" },
        {
          name: "open",
          type: "boolean",
          description: "Controlled visibility for the snackbar host. Omit for inline/fixture surface-only render."
        },
        {
          name: "placement",
          type: '"topLeft" | "topCenter" | "topRight" | "bottomLeft" | "bottomCenter" | "bottomRight"',
          default: '"bottomCenter"',
          description: "Viewport corner/edge when hosted (MUI Snackbar anchorOrigin)."
        },
        {
          name: "offset",
          type: "number",
        ...
        },
        {
          name: "surfaceOnly",
          type: "boolean",
          description: "Render elevated chrome without the snackbar portal. Default when open is omitted."
        }
      ],
      variableDependencies: [
        "--background-brand-light",
    ...
    },
    {
      ...
      props: [
        ...
        { name: "hasCaret", type: "boolean", default: "true" },
        {
          name: "aria-label",
          type: "string",
          description: "Accessible trigger name. Falls back to title when title is a plain string; required when title is rich content."
        }
      ],
      variableDependencies: [
        "--text-brand-primary",
    ...
    },
    {
      ...
      props: [
        { name: "title", type: "ReactNode", required: !0 },
        {
          name: "children",
          type: "ReactElement",
          description: "Trigger element. Required for anchored mode; omit with surfaceOnly."
        },
        {
          name: "placement",
          type: '"bottom-start" | "bottom" | "bottom-end" | "top-start" | "top" | "top-end" | "left-start" | "left" | "left-end" | "right-start" | "right" | "right-end"',
    ...
    },
    {
      ...
      props: [
        ...
        { name: "title", type: "ReactNode" },
        {
          name: "body",
          type: "ReactNode",
          description: "Default body copy (pre-seed). Used when children is omitted — full body on default, text slot on image layouts."
        },
        { name: "image", type: "ReactNode" },
        {
          name: "children",
          type: "ReactNode",
          description: "Custom content for the body text slot (Figma customContent). Replaces body for every type; image layouts keep the fixed image slot."
        },
        { name: "hasSecondaryAction", type: "boolean", default: "true" },
        { name: "primaryActionLabel", type: "ReactNode", default: '"Button"' },
        {
      ...
      props: [
        {
          ...
          default: '"default"',
          description: "Shape family: circle, panel diamond, checkered-flag glyph, Tutor+ mark."
        },
        {
          name: "status",
          type: '"notStarted" | "inProgress" | "passed" | "completed" | "error"',
          default: '"notStarted"',
          description: "Completion status chrome. Ignored for lessonExtras / tutorPlus (Figma status N/A)."
        },
        {
          name: "isActive",
          type: "boolean",
          default: "false",
          description: "Current level — renders the 24px bubble with the level number."
        },
        {
          name: "isAssessment",
          type: "boolean",
          default: "false",
          description: "Assessment level — inline star (inactive) or top-right star badge (active)."
        },
        {
          name: "levelNumber",
          type: "ReactNode",
        ...
        },
        {
          ...
          type: "boolean",
          default: "true",
          description: "false renders a non-pressable span (e.g. nested inside the Progress Widget dropdown start icon)."
        }
      ],
      variableDependencies: [
        "--background-neutral-primary",
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          description: "Levels rendered as progress bubbles in the desktop rail ({ levelType, status, isAssessment, label, onClick })."
        },
        {
          name: "activeLevelIndex",
          type: "number",
          description: "Index of the current level; renders large in the rail and nests in the dropdown below 960px."
        },
        {
          name: "breakpoint",
        ...
        },
        {
          ...
          type: '"saved" | "offline"',
          default: '"saved"',
          description: "Cloud icon state: cloud-check (saved) or cloud-slash (offline)."
        },
        {
          name: "saveStatusLabel",
          type: "string",
          description: 'Cloud tooltip label; defaults to "Saved 2 minutes ago" / "Offline".'
        },
        {
          name: "hasAction",
          type: "boolean",
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          description: "Progress widget props for labLevel / nonLabLesson (breakpoint follows the header)."
        },
        {
          name: "projectTitle",
          type: "string",
        ...
        },
        {
          ...
          description: "Dashboard nav links; defaults per state (teacher includes Professional Learning)."
        },
