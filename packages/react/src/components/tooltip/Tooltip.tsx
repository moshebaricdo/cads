...
function TooltipCaret({
  ...
  return (
    ...
    >
      <span className={styles.caretDiamond} />
    </Box>
  );
}
...
function TooltipSurface({
  ...
  const bubble = (
    <span
      className={`${styles.bubble} cads-tooltip-surface`}
      style={{
  ...
  return (
    <div
      ...
      role="tooltip"
      className={`${styles.surfaceWrap} ${horizontal ? styles.horizontal : styles.vertical}`}
    >
...
export function Tooltip({
  ...
  /* sx on MUI Tooltip slots is required to beat MUI's internal styling. */
  return (
    <MuiTooltip
      {...rest}
      title={content}
