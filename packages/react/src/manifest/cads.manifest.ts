  ...
  components: [
    {
      ...
      props: [
        ...
        },
        {
          ...
          default: '"primary"',
          description:
            "Color role. Tertiary is only for text + icon-only; orange is only for contained (run button). Other combos fall back (tertiary→secondary, orange→primary).",
        },
        {
          name: "size",
        ...
        { name: "endIconName", type: "FaIconName" },
        {
          ...
          type: "boolean",
          description:
            "Replaces visible content with a centered FA spinner; preserves button width (no layout shift). Does not use disabled styling.",
        },
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          type: "FaIconName",
          description:
            "Leading FA icon inside the field. Field-only; ignored when multiline. Omit for no icon (Figma boolean startIcon collapsed into presence of this prop).",
        },
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          default: '"hug"',
          description:
            'Menu panel sizing. "hug" fits content (never narrower than the trigger); "trigger" locks to the trigger; a number sets a px minimum; a percentage is an exact trigger-relative width.',
        },
        {
          name: "options",
          type: "DropdownOption[]",
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          default: '"left"',
          description:
            "Label on the left (switch right) or label on the right (switch left). Corrects inverted Figma axis naming.",
        },
        { name: "label", type: "ReactNode" },
        { name: "checked", type: "boolean" },
        { name: "defaultChecked", type: "boolean" },
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          default: "100",
          description:
            "Range maximum. Default 100 for both side and center.",
        },
        {
          name: "width",
          type: "number | string",
          default: "300",
          description:
            'Control width. Numbers are px; strings are CSS lengths (e.g. "16rem"). Ignored when fullWidth is true. Default matches Figma (300px).',
        },
        {
          name: "fullWidth",
          type: "boolean",
    ...
    },
    {
      ...
      props: [
        ...
        { name: "label", type: "ReactNode" },
        {
          ...
          type: "FaIconName",
          description:
            "Leading FA icon. Omit for no start icon (Figma boolean startIcon collapsed into presence of this prop).",
        },
        {
          name: "endIconName",
          type: "FaIconName",
          description:
            "Trailing FA icon. Omit for no end icon (Figma boolean endIcon collapsed into presence of this prop).",
        },
        { name: "disabled", type: "boolean" },
        { name: "onClick", type: "(event) => void" },
        { name: "aria-label", type: "string" },
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          required: true,
          description:
            "Trail items. Optional per-item iconName (leading icon on any crumb), iconOnly, current (Figma isCurrent), href/onClick.",
        },
        {
          name: "maxItems",
          type: "number",
          default: "8",
          description:
            "MUI-compatible. Collapse middle into Overflow ellipsis when exceeded.",
        },
        {
        ...
        },
        {
          ...
          default: "1",
          description:
            "MUI-compatible. Crumbs kept after the overflow ellipsis (Figma default composition uses 2).",
        },
        {
          name: "expandText",
          type: "string",
    ...
    },
    {
      ...
      props: [
        ...
        { name: "children", type: "ReactNode" },
        {
          ...
          description:
            "Leading icon. Omit for sentiment default; false hides the icon (MUI convention); string overrides.",
        },
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          default: "false",
          description:
            "When true, the tooltip opens only on keyboard focus-visible (not hover). MUI already gates focus with isFocusVisible — use this for keyboard-user-specific context.",
        },
      ],
      variableDependencies: [
        "--background-neutral-primary-inverse",
    ...
    },
    {
      ...
      props: [
        ...
        { name: "image", type: "ReactNode" },
        {
          ...
          default: '"smile"',
          description:
            "Icon for the floating badge when type is iconTop (Figma shortcode; smile → face-smile).",
        },
        { name: "hasSecondaryAction", type: "boolean", default: "true" },
        { name: "primaryActionLabel", type: "ReactNode", default: '"Button"' },
        {
        ...
        { name: "onClose", type: "() => void" },
        {
          ...
          default: "800",
          description:
            "Max surface width. Number is px; strings accept any CSS length. Width stays 100% up to this cap.",
        },
        { name: "open", type: "boolean", default: "false" },
        { name: "children", type: "ReactNode" },
        { name: "surfaceOnly", type: "boolean" },
  ...
  <Modal open={open} onClose={() => setOpen(false)} type="default" title="Title">
    ...
    },
    {
      ...
      figma: {
        fileKey: CADS_FIGMA_FILE_KEY,
        nodeId: "17228:10910",
        componentKey: "964982bddf995c79023e3baad45b8a15e3f83716",
      },
      props: [
        { name: "disabled", type: "boolean" },
        { name: "onClick", type: "(event) => void" },
      ...
      usageRules: [
        "Prefer composing via AiChatFileChip useCase=inputField rather than placing alone.",
        "Hover/press use error fills to signal destructive remove.",
      ],
      example: `<ChatFileRemoveButton onClick={onRemove} aria-label="Remove attachment" />`,
    },
    {
      name: "AiChatFileChip",
      ...
      figma: {
        fileKey: CADS_FIGMA_FILE_KEY,
        nodeId: "17228:10810",
        componentKey: "5bfa5b80e991b7413e03faa32def297190dd2efc",
      },
      props: [
        {
          name: "type",
        ...
        },
        {
          ...
          default: '"chatStream"',
          description: "inputField shows the remove control.",
        },
        { name: "fileName", type: "ReactNode", default: '"filename.ext"' },
        {
          name: "metadata",
          type: "ReactNode",
          default: '"12:56PM"',
        ...
        { name: "imageAlt", type: "string", default: '"Attachment"' },
        {
          name: "iconName",
          type: "FaIconName",
          default: '"file-code"',
          description: "Brand tile icon for file/codeSnippet.",
        },
      ...
      usageRules: [
        "Use chatStream in the message transcript; inputField in AiChatInput attachments.",
        "Pass imageSrc for type=image thumbnails.",
      ],
      example: `<AiChatFileChip type="file" useCase="inputField" fileName="lesson.pdf" onRemove={onRemove} />`,
    },
    {
      name: "AiChatMessage",
      ...
      figma: {
        fileKey: CADS_FIGMA_FILE_KEY,
        nodeId: "17228:10789",
        componentKey: "2e5573fb8a81ad428869ea8b04621747b1787a64",
      },
      props: [
        {
          name: "context",
          type: '"TA" | "Tutor"',
          default: '"TA"',
          description: "Teacher Assistant vs student Tutor product context.",
        },
        {
          name: "author",
          type: '"Human" | "AI"',
        ...
        },
        {
          name: "fileUploads",
          type: "ReactNode",
          description: "Optional AiChatFileChip row above an AI bubble.",
        },
        { name: "hasActionRow", type: "boolean", default: "true" },
        { name: "hasLeftActions", type: "boolean", default: "true" },
        {
          name: "hasDownload",
          type: "boolean",
          default: "true",
        ...
        { name: "hasRightActions", type: "boolean", default: "true" },
        { name: "hasFlagging", type: "boolean", default: "true" },
        {
          name: "feedbackLabel",
          type: "ReactNode",
        ...
        { name: "onDownload", type: "() => void" },
        {
          name: "helpfulValue",
          type: '"up" | "down" | null',
          description: "Controlled thumbs feedback.",
        },
        { name: "defaultHelpfulValue", type: '"up" | "down" | null' },
        {
          name: "onHelpfulChange",
          type: '(value: "up" | "down" | null) => void',
        },
        { name: "flagged", type: "boolean" },
        { name: "defaultFlagged", type: "boolean" },
      ...
      example: `<AiChatMessage context="TA" author="AI">Sure — try a 10× name loop warm-up.</AiChatMessage>`,
    },
    {
      name: "AiChatInput",
      ...
      figma: {
        fileKey: CADS_FIGMA_FILE_KEY,
        nodeId: "17228:10734",
        componentKey: "21631db16f6743b826a673366f733746b019284f",
      },
      props: [
        { name: "value", type: "string" },
        { name: "defaultValue", type: "string" },
        ...
        { name: "addFileLabel", type: "ReactNode", default: '"Add file"' },
      ...
      usageRules: [
        "Filled chrome (enabled send) is derived from non-empty value — do not pass a separate isFilled prop.",
        "Enter submits; Shift+Enter inserts a newline.",
        "Pass attachments as AiChatFileChip with useCase=inputField.",
      ],
      example: `<AiChatInput placeholder="Ask anything" onSubmit={onSend} onAddFile={onAttach} />`,
    },
    {
      name: "FaIcon",
      exportName: "FaIcon",
      ...
      description:
        "Font Awesome 7 webfont glyph (solid/regular/brands). Docs use Pro; the published package ships Free.",
      props: [
    ...
    },
    {
      ...
      importFrom: "@moshebari/cads-react",
      description:
        "Lab progress widget from the Global Header: level dropdown + cloud sync status + progress-bubble rail + action button. Below 960px the rail folds away, a leading back button appears, and the active level bubble nests inside the dropdown. Below 600px the dropdown shows the lesson number (cloud stays).",
      figma: {
        fileKey: CADS_FIGMA_FILE_KEY,
        nodeId: "17307:1036",
      },
      props: [
        ...
        },
        {
          ...
          default: '"auto"',
          description:
            "auto: rail ≥960, folded name 600–959, number-only <600 (cloud stays). desktop / tabletMobile / mobile force a layout.",
        },
        {
          name: "saveStatus",
          type: '"saved" | "offline"',
    ...
    },
    {
      ...
      importFrom: "@moshebari/cads-react",
      description:
        "Persistent Studio header chrome. Six page states (lab level, non-lab lesson, standalone project, teacher/student dashboard, Tutor+) with desktop (≥960px), tablet (600–959), and phone (<600) layouts.",
      figma: {
        fileKey: CADS_FIGMA_FILE_KEY,
        nodeId: "17240:2903",
      },
      props: [
        ...
        },
        {
          ...
          default: '"auto"',
          description:
            "auto: desktop ≥960, tablet 600–959, phone <600. Named values force a layout.",
        },
        {
          name: "username",
          type: "string",
